...
const Review = ({ navigation }) => {
  ...
  if (loading) return <ActivityIndicator />
    ...
    <ImageBackground resizeMode={"cover"} source={require('../assets/date-dealer-home-background.png')} style={styles.container}>
      ...
      <Text style = {{color:'black', fontSize:20,textAlign:'center'}}>{"Hi "}{ name + "! Thank you so much for downloading Date Dealer."}  {"\n"}  {"\n"} {"If you would like to leave a review or share with a friend, please use one of the links below!"}</Text>
